...
public class LAGCreditController {
    ...
    public String deploy_web() {
        ...
        return ("LAGC address is " + lagCredit.getContractAddress());
    }

    @RequestMapping(value="/transfer",method= RequestMethod.GET, produces = "application/json;charset=UTF-8")
    public String transfer_web(@RequestParam("address") String creditAddress,@RequestParam("to") String to,@RequestParam("value") BigInteger value){
